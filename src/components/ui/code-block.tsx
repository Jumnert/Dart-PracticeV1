    ...
    >
      <div className="border-border bg-card overflow-hidden rounded-lg border shadow-xs">
        ...
        <Collapsible open={!isCollapsed}>
          <div
            className={cn(
              "overflow-x-auto overflow-y-clip text-sm [&_.shiki]:!bg-transparent [&_pre]:px-0 [&_pre]:py-4",
          ...
          {shouldCollapse && (
            <CollapsibleTrigger asChild><Button variant="ghost" onClick={() => setIsExpanded(!isExpanded)} className="text-muted-foreground w-full rounded-none border-t font-normal">{isCollapsed ? (
                                        <>
